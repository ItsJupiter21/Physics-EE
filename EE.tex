...
\section{Methodology} \label{Methodology}%999
    ...
    \end{tabular}
    \end{center}
    \caption{Table of Variables for the Simulation}\label{fig:VarTable}
    \end{figure}
    The table of variables, is shown in Figure \ref{fig:VarTable}. The length $l$ and energy $E$ will be changed according to \eqref{eqn:constants} and a separate simulation will be ran for each.
    ...
    \end{tabular}
    \end{center}
    \caption{Table Of Variables for the Experiment}\label{fig:ExpVarTable}
    \end{figure}
